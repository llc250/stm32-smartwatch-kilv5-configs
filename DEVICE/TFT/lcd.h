...
#define LCD_SCL_GPIO_PIN				GPIO_Pin_11
...
#define LCD_SCLK_Clr() GPIO_ResetBits(LCD_SCL_GPIO_PORT,LCD_SCL_GPIO_PIN)//SCL=SCLK  低电平
#define LCD_SCLK_Set() GPIO_SetBits(LCD_SCL_GPIO_PORT,LCD_SCL_GPIO_PIN)  // 高电平
...
#define HATSUNE_GREEN    0x3776  // 官方苍绿色（初音绿）
#define HATSUNE_BLUE     0x05EA  // 冰蓝色（偏蓝初音）
